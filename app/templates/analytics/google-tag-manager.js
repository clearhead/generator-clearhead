;(function(){try{
var experimentId = $['exp<%=idx%>'].id; // experiment id (this should be a number, not a string)
var chDimension = $['exp<%=idx%>'].cv; // 1,2,3,4,5 (this should be a number, not a string)
